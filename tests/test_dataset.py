...
def test_load_dark():
    ...
    result = gchop.dataset.load_dark()
...
def test_load_star():
    ...
    result = gchop.dataset.load_star()
...
def test_load_dark_TNG_394242():
    ...
    result = gchop.dataset.load_dark_394242()
...
def test_load_gas_TNG_394242():
    ...
    result = gchop.dataset.load_gas_394242()
...
def test_load_star_TNG_394242():
    ...
    result = gchop.dataset.load_star_394242()
...
def test_load_pot_dark_TNG_394242():
    ...
    result = gchop.dataset.load_pot_dark_394242()
...
def test_load_pot_gas_TNG_394242():
    ...
    result = gchop.dataset.load_pot_gas_394242()
...
def test_load_pot_star_TNG_394242():
    ...
    result = gchop.dataset.load_pot_star_394242()
